...
public class Command {
     ...
     * 营运数据应答
     * 收到运营数据时
     * 55AA0031020100E4415830303031202020200002202302252047202302252119000000020000000000162500130000000000130001A355AA
     * result.startsWith("55AA") && result.endsWith("55AA") && result.length() > 16
     * && result.startsWith("E4", 14)
     * 发送
     */
    public static final String CMD_END_RESPONSE = "55 AA 00 05 00 00 00 E4 90 71 55 AA".replace(" ", "");

    public static final String CMD_PARAMETERS_ENQUIRY = "55 AA 00 0A 00 00 10 A4 20 23 02 25 20 03 B9 55 AA"
            .replace(" ", "");
